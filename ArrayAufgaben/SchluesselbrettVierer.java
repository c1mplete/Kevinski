 ...
 * @author KevTom
 */
public class SchluesselbrettVierer {
    
    Schluessel[] schluesselliste = new Schluessel[5];
    


    
    public void schluesselAnsBrettHaengen(Schluessel key){
        
        for(int i = 0; i < schluesselliste.length;i++){
            if(schluesselliste[i] == null){
                schluesselliste[i] = key;
            }
        }
